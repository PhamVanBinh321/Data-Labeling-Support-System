...
FIREBASE_CREDENTIALS_PATH = config('FIREBASE_CREDENTIALS_PATH', default='/app/firebase-credentials.json')
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'notifications.backends.ServiceJWTAuthentication',
    ),
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API quản lý in-app notifications cho hệ thống Data Labeling.',
    'VERSION': '1.0.0',
