...
SECRET_KEY=${KEY_AUTH}
DEBUG=False
ALLOWED_HOSTS=${VPS_IP},localhost,auth-service,api.datalabelsystem.site
DATABASE_URL=postgresql://auth_user:auth_pass@auth-db:5432/auth_db
JWT_ACCESS_TOKEN_LIFETIME_MINUTES=60
JWT_REFRESH_TOKEN_LIFETIME_DAYS=7
JWT_SIGNING_KEY=${SHARED_JWT}
REDIS_URL=redis://redis:6379/0
CORS_ALLOWED_ORIGINS=http://localhost:5173,http://127.0.0.1:5173,https://data-labeling-support-system-three.vercel.app
ENVEOF

cat > project-service/.env <<ENVEOF
SECRET_KEY=${KEY_PROJECT}
DEBUG=False
ALLOWED_HOSTS=${VPS_IP},localhost,project-service,api.datalabelsystem.site
...
SECRET_KEY=${KEY_TASK}
DEBUG=False
ALLOWED_HOSTS=${VPS_IP},localhost,task-service,api.datalabelsystem.site
...
DEBUG=False
ALLOWED_HOSTS=${VPS_IP},localhost,annotation-service,api.datalabelsystem.site
...
MINIO_PUBLIC_HOST=https://api.datalabelsystem.site
MINIO_USE_SSL=False
CORS_ALLOWED_ORIGINS=http://localhost:5173,http://127.0.0.1:5173,https://data-labeling-support-system-three.vercel.app
ENVEOF
...
DEBUG=False
ALLOWED_HOSTS=${VPS_IP},localhost,notification-service,api.datalabelsystem.site
...
DEBUG=False
ALLOWED_HOSTS=${VPS_IP},localhost,admin-service,api.datalabelsystem.site
